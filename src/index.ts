...
const customer1 = new Customer("Choke Dee","85 malaiman rode, nakpatom");
...
const item3 = new Item(0.8,"Mama",10);
...
const orderDetail3= new OrderDetail(item1,2,"not included");
...
// เงินทอน
console.log("SupTotal:"+ order1.calcSubtotal()+"฿");
